...
%% Runs OmniCUDA_Iterative with system() [Put the OmniCUDA_Iterative.exe file in this folder]
disp('Firing OmniCUDA_Iterative...')
system('OmniCUDA_Iterative.exe'); %[Put the OmniCUDA_Iterative.exe file in this folder]
